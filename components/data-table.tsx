      ...
      <div className="">
        <div className="flex flex-col lg:flex-row justify-between items-start ml-[23px] mr-[33px] py-4">
          ...
          <div className="flex items-center gap-[13px]">
            <Select>
              <SelectTrigger className="w-[111px] border border-[#EBEBEB] shadow-sm text-sm text-[#5C5C5C] h-9">
              ...
              <TableRow key={headerGroup.id}>
                {headerGroup.headers.map((header) => {
                  return (
                    <TableHead
                      key={header.id}
                      className="text-sm text-[#5C5C5C] font-medium tracking-[-0.6%] leading-[20.3px] bg-[#F9F9F9] px-6 py-4"
                    >
